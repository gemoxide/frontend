...
const Navigation = () => {
    ...
    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
         ...
         */}
        <button type="button" className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" style={ buttonStyle } onClick={handleLogout}>Logout</button>
    ...
    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        ...
        <li>
            <a className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" style={ style1.container } aria-current="page" onClick={goToIndex}>Home</a>
        </li>
        <li>
